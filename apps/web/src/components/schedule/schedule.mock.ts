...
export const plannedBlocks: ScheduleBlock[] = [
  ...
  { id: 'p9', date: '2026-05-20', title: 'Calendar sync research', type: 'research', startMin: 900, durationMin: 60, description: 'Shape the first pass for imported calendar context.' },
...
export const actualBlocks: ScheduleBlock[] = [
  ...
  { id: 's10', date: '2026-05-20', title: 'Calendar sync research', type: 'research', startMin: 900, durationMin: 60 },
