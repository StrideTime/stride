...
| **Time budget** | An optional goal for how much time a user wants to spend in selected schedule event types. | **Deferred from MVP** (2026-05-21). One active budget mode at a time: daily or weekly. Budgets are duration-based targets, not hard constraints. |
